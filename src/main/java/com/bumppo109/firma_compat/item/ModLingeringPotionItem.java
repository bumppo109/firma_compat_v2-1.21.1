...
public class ModLingeringPotionItem extends FluidPotionItem {

    public ModLingeringPotionItem(Properties properties) {
        super(properties);
    }

    @Override
    protected EntityType<FluidPotionProjectile> projectileType() {
        return ModEntities.FLUID_LINGERING_POTION.get();
    }
