...
public interface ModPotRecipes extends ModRecipes{
    ...
    {
        jam(ModItems.SWEET_BERRIES.get(), ModItems.UNSEALED_FRUIT_PRESERVES.get(FoodIngredients.SWEET_BERRIES).get(), ModItems.FRUIT_PRESERVES.get(FoodIngredients.SWEET_BERRIES).get());
        jam(ModItems.GLOW_BERRIES.get(), ModItems.UNSEALED_FRUIT_PRESERVES.get(FoodIngredients.GLOW_BERRIES).get(), ModItems.FRUIT_PRESERVES.get(FoodIngredients.GLOW_BERRIES).get());
    }
