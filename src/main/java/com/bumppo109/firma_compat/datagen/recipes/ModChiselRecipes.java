...
public interface ModChiselRecipes extends ModRecipes
{
    default void chiselRecipes()
    {
        for (CompatRock rock : CompatRock.VALUES) {
            ...
            RockSet rawSet = material.raw();
            RockSet smoothSet = material.smooth();
            RockSet polishedSet = material.polished();
            RockSet chiseledSet = material.chiseled();
            RockSet brickSet = material.brick();
            RockSet chiseledBrickSet = material.chiseledBrick();
        ...
        for(Rock rock : Rock.values()) {
            ...
            chiselStair(List.of(rockMap.get(CompatRock.BlockType.COBBLESTONE)), decorationMap.get(Rock.BlockType.COBBLE).stair());
            chiselSlab(List.of(rockMap.get(CompatRock.BlockType.COBBLESTONE)), decorationMap.get(Rock.BlockType.COBBLE).slab());
            chiselStair(List.of(rockMap.get(CompatRock.BlockType.MOSSY_COBBLESTONE)), decorationMap.get(Rock.BlockType.MOSSY_COBBLE).stair());
            chiselSlab(List.of(rockMap.get(CompatRock.BlockType.MOSSY_COBBLESTONE)), decorationMap.get(Rock.BlockType.MOSSY_COBBLE).slab());
        }
