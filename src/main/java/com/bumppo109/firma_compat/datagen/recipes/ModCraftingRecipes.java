...
public interface ModCraftingRecipes extends ModRecipes {
    ...
    default void craftingRecipes() {
        for (CompatWood wood : CompatWood.values()) {
            ...
            recipe()
                    .input('W', Objects.requireNonNull(material.strippedLog().get()))
            ...
            recipe()
                    .input('L', lumber)
                    .input('S', Objects.requireNonNull(material.strippedLog().get()))
            ...
            recipe()
                    .input('P', Objects.requireNonNull(material.log().get()))
                    .input('L', lumber)
                    .pattern("PLP", "PLP")
            ...
            recipe("from_planks")
                    .inputIsPrimary(TFCTags.Items.TOOLS_SAW)
                    .input(Objects.requireNonNull(material.planks().get()))
                    .damageInputs()
                    .shapeless(lumber, 4);
            recipe("from_stairs")
                    .inputIsPrimary(TFCTags.Items.TOOLS_SAW)
                    .input(Objects.requireNonNull(material.plankStairs().get()))
                    .damageInputs()
                    .shapeless(lumber, 3);
            recipe("from_slabs")
                    .inputIsPrimary(TFCTags.Items.TOOLS_SAW)
                    .input(Objects.requireNonNull(material.plankSlab().get()))
                    .damageInputs()
                    .shapeless(lumber, 2);
            recipe()
                    .input('F', Tags.Items.FEATHERS)
                    .input('D', Tags.Items.DYES_BLACK)
                    .input('S', Objects.requireNonNull(material.plankSlab().get()))
                    .input('W', Objects.requireNonNull(material.planks().get()))
                    .pattern("F D", "SSS", "W W")
                    .shaped(blocks.get(CompatWood.BlockType.SCRIBING_TABLE));
            recipe()
                    .input('S', Tags.Items.TOOLS_SHEAR)
                    .input('L', Tags.Items.LEATHERS)
                    .input('P', Objects.requireNonNull(material.planks().get()))
                    .input('G', Objects.requireNonNull(material.log().get()))
                    .pattern(" LS", "PPP", "G G")
            ...
            //Replace Vanilla
            recipe().to2x2(lumber, Objects.requireNonNull(material.planks().get()), 1);

            recipe()
                    .input('L', lumber)
                    .pattern("LL", "LL", "LL")
                    .shaped(Objects.requireNonNull(material.door().get()));
            recipe()
                    .input('P', Objects.requireNonNull(material.planks().get()))
                    .input('L', lumber)
                    .pattern("PLP", "PLP")
                    .shaped(Objects.requireNonNull(material.fence().get()), 8);
            recipe()
                    .input('P', Objects.requireNonNull(material.planks().get()))
                    .input('L', lumber)
                    .pattern("LPL", "LPL")
                    .shaped(Objects.requireNonNull(material.fenceGate().get()), 2);
            recipe()
                    .input('L', lumber)
                    .pattern("LLL", "LLL")
                    .shaped(Objects.requireNonNull(material.trapdoor().get()), 2);
            recipe()
                    .input('L', lumber)
                    .input('S', Tags.Items.RODS_WOODEN)
                    .pattern("LLL", "LLL", " S ")
                    .shaped(Objects.requireNonNull(material.sign().get()), 3);
            recipe()
                    .input('L', lumber)
                    .input('S', Tags.Items.CHAINS)
                    .pattern("S S", "LLL", "LLL")
                    .shaped(Objects.requireNonNull(material.hangingSign().get()), 4);
            recipe()
                    .input('L', lumber)
                    .pattern("LL")
                    .shaped(Objects.requireNonNull(material.pressurePlate().get()));
        }
        ...
        for(Rock rock : Rock.values()){
            ...
            cobbleMap.forEach((blockType, blockId) -> {
                Rock.BlockType tfcLoose = blockType.equals(CompatRock.BlockType.COBBLESTONE) ? Rock.BlockType.LOOSE : Rock.BlockType.MOSSY_LOOSE;
                Rock.BlockType tfcCobble = blockType.equals(CompatRock.BlockType.COBBLESTONE) ? Rock.BlockType.COBBLE : Rock.BlockType.MOSSY_COBBLE;

                Block cobble = cobbleMap.get(blockType).get();
                Block loose = tfcMap.get(tfcLoose).get();
                Block slab = decorationMap.get(tfcCobble).slab().get();
                Block stair = decorationMap.get(tfcCobble).stair().get();
                Block wall = decorationMap.get(tfcCobble).wall().get();
            ...
            if (material != null) {
                ...
                if (material.cobble() != null) {
                    ...
                    recipe()
                            ...
                            .input('X', TFCItems.MORTAR)
                            .pattern("LXL", "XLX", "LXL")
                            .shaped(ModBlocks.ROCK_BLOCKS.get(rock).get(CompatRock.BlockType.COBBLESTONE).get(),1);

                    addDecorations(ModBlocks.ROCK_BLOCKS.get(rock).get(CompatRock.BlockType.COBBLESTONE).get(),
                            ModBlocks.ROCK_DECORATIONS.get(rock).get(CompatRock.BlockType.COBBLESTONE));
                }
                if (material.mossyCobble() != null) {
                    ...
                    recipe()
                            ...
                            .input('X', TFCItems.MORTAR)
                            .pattern("LXL", "XLX", "LXL")
                            .shaped(ModBlocks.ROCK_BLOCKS.get(rock).get(CompatRock.BlockType.MOSSY_COBBLESTONE).get(),1);

                    addDecorations(ModBlocks.ROCK_BLOCKS.get(rock).get(CompatRock.BlockType.MOSSY_COBBLESTONE).get(),
                            ModBlocks.ROCK_DECORATIONS.get(rock).get(CompatRock.BlockType.MOSSY_COBBLESTONE));
                }

                //smooth -> polished -> chiseled
                RockSet previousChisel = material.raw();
        ...
        recipe()
                .input('L', Tags.Items.GEMS_AMETHYST)
                .pattern("LL ", "LL ")
