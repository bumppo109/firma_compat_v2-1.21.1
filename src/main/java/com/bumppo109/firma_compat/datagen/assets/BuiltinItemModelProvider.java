...
public class BuiltinItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        for (CompatWood wood : CompatWood.VALUES) {
            ...
            uncheckedBasicItem(ModBlocks.WOODS.get(wood).get(CompatWood.BlockType.TWIG).get().asItem());
            if (wood.woodMaterial().leaves() != null) {
                uncheckedBasicItem(ModBlocks.WOODS.get(wood).get(CompatWood.BlockType.FALLEN_LEAVES).get().asItem());
            }
